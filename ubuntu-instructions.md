...
## 3. Install GryphonEC-ROS2 dependencies

Let’s get all the extra goodies for GryphonEC-ROS2 and Asgard:
...
## 4. Clone the GryphonEC-ROS2 repository

Let’s get the code!

```bash
cd ~/
git clone https://github.com/MahmoudEmadSlman/GryphonEC-ROS2
```
---
