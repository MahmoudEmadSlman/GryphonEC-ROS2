...
class RandomCommander(Node):
    def __init__(self):
        ...
        self.predefined_positions = [
            {'joint_1': 0.0, 'joint_2': -0.5, 'joint_3': 0.5, 'joint_4': 0.0, 'joint_5': 0.0},
            {'joint_1': 1.0, 'joint_2': 0.5, 'joint_3': -0.5, 'joint_4': 0.3, 'joint_5': -0.2},
            {'joint_1': -1.2, 'joint_2': 0.4, 'joint_3': 0.0, 'joint_4': -0.4, 'joint_5': 0.6},
            {'joint_1': 0.7, 'joint_2': -0.8, 'joint_3': 0.2, 'joint_4': 0.1, 'joint_5': -0.1},
