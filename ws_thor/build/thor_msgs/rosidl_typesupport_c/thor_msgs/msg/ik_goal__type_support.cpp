...
static const _IKGoal_type_support_symbol_names_t _IKGoal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thor_msgs, msg, IKGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, thor_msgs, msg, IKGoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, thor_msgs, msg, IKGoal)() {
  return &::thor_msgs::msg::rosidl_typesupport_c::IKGoal_message_type_support_handle;
}
