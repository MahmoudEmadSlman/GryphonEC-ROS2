...
static rosidl_typesupport_introspection_c__MessageMember thor_server__action__JointTask_Goal__rosidl_typesupport_introspection_c__JointTask_Goal_message_member_array[6] = {
  {
    "joint1_deg",  // name
