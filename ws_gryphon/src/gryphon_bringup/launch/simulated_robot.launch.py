...
def generate_launch_description():
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("gryphon_urdf"),
                "launch",
                "gazebo.launch.py"
            )
        )
    ...
    controller = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("gryphon_controller"),
                "launch",
    ...
    moveit = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("gryphon_moveit"),
                "launch",
                "moveit.launch.py"
            )
        ),
    ...
    rosbridge = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("gryphon_bringup"),
                "launch",
                "rosbridge.launch.py"
            )
        )
    ...
    status_publisher = Node(
        package="gryphon_status_publisher",
